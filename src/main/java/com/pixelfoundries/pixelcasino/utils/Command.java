...
import com.pixelfoundries.pixelcasino.PixelCasino;
...
//                                        player1.sendMessage(TextSerializers.FORMATTING_CODE.deserialize("&a Progress of &e" + arg + ": " + PixelCasino.getDatabase().getProgress(Sponge.getServer().getPlayer(arg).get().getUniqueId(), questLine)));
                                    });
...
//                                            PixelCasino.getDatabase().setProgress(Sponge.getServer().getPlayer(arg).get().getUniqueId(), questLine, Integer.parseInt(progress));
                ...
                .build();
        Sponge.getCommandManager().register(PixelCasino.instance, spec, "pp", "pixelcasino");
    }
